...
namespace batch {
    ...
    void BatchCreator::writeHideShellStart() { *this->batchFile << "@ECHO OFF\n"; }

    void BatchCreator::writeHideShellEnd() { *this->batchFile << "@ECHO ON\n"; }
...
/// \bug Currently always opens new shell
    ...
    void BatchCreator::writePathValue() {
        ...
        *this->batchFile << "SET PATH=%PATH%;" << additionalPaths.str();
    }
